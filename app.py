...
if search_btn and user_input:
    ...
    if not top3.empty:
        ...
        for _, rec in top3.iterrows():
            ...
            st.write(f'参加者の反応: {rec["D17"]}' if "D17" in rec else "")
            # シートへのリンク（gidが取得できていれば表示）
